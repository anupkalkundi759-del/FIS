def run_engine(conn, cur):
    ...
    # ================= MAIN LOGIC =================
    for house in df["house"].unique() if not df.empty else []:
    ...
    # ================= BOTTLENECK =================
    if df.empty:
        bottleneck_msg = "No data available"
    ...
    priority_df = result_df[result_df["SLA"].notna()] if not result_df.empty else result_df
