def run_engine(conn, cur):
    ...
    # =========================================================
    # ACTIVITY MASTER / STANDARD DURATION WEIGHTS
    # =========================================================
    cur.execute("""
    ...
    project_planned_progress = round(
        sum(planned_progress_list) / len(planned_progress_list), 2
